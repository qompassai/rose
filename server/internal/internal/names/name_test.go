...
func TestParseName(t *testing.T) {
	cases := []struct {
		...
		{"qompass.ai/archive/_:latest", Name{h: "qompass.ai", n: "archive", m: "_", t: "latest"}},
...
func TestMerge(t *testing.T) {
	cases := []struct {
		...
		{"bmizerany/smol", "qompass.ai/archive/_:latest", "qompass.ai/bmizerany/smol:latest"},
