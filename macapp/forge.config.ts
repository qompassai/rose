...
const config: ForgeConfig = {
  packagerConfig: {
    ...
    extraResource: [
      path.join(__dirname, '../dist/darwin/rose'),
      ...fs.readdirSync(path.join(__dirname, '../dist/darwin-amd64/lib/rose')).map(f => path.join(__dirname, '../dist/darwin-amd64/lib/rose', f)),
